...
<head>
    ...
    <body class="page-body  page-fade" onload="collapseSidebar()" id="img1">
        ...
        <div class="a1-card-8 a1-light-gray" style="width:600px; margin:0 ;">
...
<style>
	#img1{
		background-image: url(https://fashionsista.co/downloadpng/png/20200803/black-abstract-wallpapers-images-photos-pictures-backgrounds.jpg);
	}
	*{
