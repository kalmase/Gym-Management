...
<body class="page-body  page-fade" onload="collapseSidebar()" >
	...
	<div class="page-container sidebar-collapsed" id="navbarcollapse" >
		...
		<div class="main-content" id="back">
			...
			<div class="a1-container a1-small a1-padding-32" style="margin-top:2px; margin-bottom:2px;" >
				<div class="a1-card-8 " style="width:500px; margin:0 ;" id="COLO">
        ...
        <style>
			#back{
				background-image: url(C:\Users\DNYANOBA DAMODARE\Desktop\MY PROJECT\simple gym\images);
				background-position: center;
				background-repeat: no-repeat;
				background-size: cover;
			}
			#COLO{
				background-image: linear-gradient( 45DEG,#0c0c0c,rgba(250,250,250,0.5));
				color: white;
			}
